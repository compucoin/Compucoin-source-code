...
uint256 hashGenesisBlock("0xf17b939b22b6f547ef69372ea2c83033f0a91e1901353a1f402542c29ead070a");
...
static const int64 nTargetSpacing = 120; // compucoin: 1 minute block
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "4th of may is such great day !!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    =  1399037952;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 222906825;
        ...
        assert(block.hashMerkleRoot == uint256("0x593ae1aa3f78fe89b1354a7edc02898d352b7d2d2519df14279ff8237af91d9d"));
        block.print();
